...
- **3차 필터 · 계정과목** — DART 재무제표 API(`fnlttSinglAcntAll`)
- 여러 회사 × 여러 계정과목을 선택하면 **비교표** 형태로 엑셀 생성
...
DART 키는 화면 상단에 직접 입력하거나, 환경변수 `DART_API_KEY` 로 지정할 수 있습니다.
